...
public class CubePLYExample {
	
		public static void main(String[] args) {
			InputStream is = SimplePLYExample.class.getResourceAsStream("dart.ply");
			List<Triangle> triangles = null;
	 
			try {
				triangles = PlyReader.read(is, Materials.metallic(ColorRGB.BLUE));
			} catch (IOException e) {
			...
			Camera camera = new PinHoleCamera(new Point3D(0, 10, 10), Point3D.ORIGIN, Vector3D.UNIT_Y);
			...
			tracer.addListeners(new ImageListener("dart10.png", "png"), new TimeListener());
		...
		public Scene getActualScene() throws IOException{
			InputStream is = SimplePLYExample.class.getResourceAsStream("dart.ply");
